...
std::shared_future<std::optional<CallbackReturn>>
...
uint32_t InboundRequestHandle::getMessageDestinationId() {
  return m_msgDestinationId;
}

UserCallTargetDTO InboundRequestHandle::getSourceModule() {
